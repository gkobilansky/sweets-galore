...
This is **Sweets Galore**, a Suika-style 2D physics merge puzzle game built with PixiJS 8, TypeScript, and Vite. The project follows an MVP architecture where business logic is separated from UI components.

The game is designed as a mobile-first PWA where players drop candy pieces that merge when identical types collide, creating a chain reaction scoring system.
...
- Turn-based tier progression: First 2 turns drop only tier 1 (Buddy Bear) pieces
...
- **Tier System**: 11-tier progression from Buddy Bear to Big Ol Cake-a-rinos with increasing scoring
